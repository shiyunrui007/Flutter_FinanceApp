  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          getItem("assets/images/icon_index.png", "首页"),
          getItem("assets/images/icon_product.png", "产品"),
          getItem("assets/images/icon_asset.png", "资产"),
          getItem("assets/images/icon_mine.png", "我的"),
        ],
